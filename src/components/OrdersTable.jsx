        ...
        {selectedOrder && (
          <>
            ...
            <Descriptions bordered column={1} size="small">
              ...
              <Descriptions.Item label="Address">{selectedOrder.shippingAddress.addressLine1}</Descriptions.Item>
              <Descriptions.Item label="Status">{selectedOrder.status}</Descriptions.Item>
              <Descriptions.Item label="Paid">
                {selectedOrder.isPaid ? `Yes (${new Date(selectedOrder.paidAt).toLocaleString()})` : "No"}
              </Descriptions.Item>
            </Descriptions>
